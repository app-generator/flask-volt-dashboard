...
- 👉 [Complete documentation](https://docs.appseed.us/products/flask-dashboards/volt) - `Learn how to use and update the product`
  - ✅ [Set up the environment](https://docs.appseed.us/products/flask-dashboards/volt#environment)
  - ✅ [Manage App users](https://docs.appseed.us/products/flask-dashboards/volt#manage-app-users)
  - ✅ [Application Bootstrap Flow](https://docs.appseed.us/products/flask-dashboards/volt#application-bootstrap-flow)
  - ✅ [UI Assets and Templates](https://docs.appseed.us/products/flask-dashboards/volt#ui-assets-and-templates)
  - ✅ [Set up the MySql Database](https://docs.appseed.us/products/flask-dashboards/volt#set-up-the-mysql-database)
  - ✅ [Static Assets for production](https://docs.appseed.us/products/flask-dashboards/volt#static-assets-for-production)  
...
![Flask Volt PRO - Premium Starter.](https://user-images.githubusercontent.com/51070104/174012256-9ec9f738-46e4-4247-b870-e1147fd0a9b3.png)
